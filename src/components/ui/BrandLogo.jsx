...
export default function BrandLogo({ to = '/', inverse = false, compact = false }) {
  return (
    <Link to={to} aria-label="Booknplay.lk home" className="inline-flex items-center gap-2 no-underline">
